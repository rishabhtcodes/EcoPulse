...
- **Administrator Account**: Configured securely via `SUPERADMIN_EMAIL` and `SUPERADMIN_PASSWORD` in your private `.env` file.
- **Sample User Account**: `student` / `student123` (Read-only environmental telemetry monitoring)
